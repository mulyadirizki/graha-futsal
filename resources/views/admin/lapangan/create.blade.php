...
@push('title')
    <title>Tambah Data Lapangan | Graha Futsal</title>
@endpush
...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="page-title">Tambah Data Lapangan</h2>
              <div class="row">
                <div class="col-md-6">
                  <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                      <form method="POST" action="{{ route('lapanganAdd') }}" class="needs-validation" novalidate>
                        @csrf
                        <div class="form-row">
                          <div class="col-md-12 mb-3">
                            <label for="kode_lapangan">Kode Lapangan</label>
                            <input type="text" class="form-control" id="kode_lapangan" name="kode_lapangan" aria-describedby="kodeLapangan" required>
                            <div class="invalid-feedback"> Kode Lapangan tidak boleh kosong </div>
                          </div>
                          <div class="col-md-12 mb-3">
                            <label for="dsc_lapangan">Nama Lapangan</label>
                            <input type="text" class="form-control" id="dsc_lapangan" name="dsc_lapangan" aria-describedby="namaLapangan" required>
                            <div class="invalid-feedback"> Nama Lapangan tidak boleh kosong </div>
                          </div>
                          <div class="col-md-12 mb-3">
                            <label for="tipe_lapangan">Tipe Lapangan</label>
                            <input type="text" class="form-control" id="tipe_lapangan" name="tipe_lapangan" aria-describedby="tipeLapangan" required>
                          ...
                          <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" id="jam_buka" name="jam_buka" required>
                                <option selected disabled>Jam Buka</option>
                          ...
                          <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" id="jam_tutup" name="jam_tutup" required>
                                <option selected disabled>Jam Tutup</option>
                                <option value="00:00:00">00:00 WIB</option>
                                <option value="01:00:00">01:00 WIB</option>
                                <option value="02:00:00">02:00 WIB</option>
                                <option value="03:00:00">03:00 WIB</option>
                          ...
                          <div class="col-md-12 mb-3">
                            ...
                            <select class="form-control" id="status_lapangan" name="status_lapangan" required>
                                <option selected disabled>Status Lapangan</option>
                          ...
                          <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" id="harga_lapangan" name="harga_lapangan" aria-describedby="hargaLapangan" required>
                        ...
                        <div class="form-group mb-3">
                          ...
                          <textarea class="form-control" id="dsc_fasilitas" name="dsc_fasilitas" placeholder="fasilitas graha futsal" required></textarea>
