...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Registrasi | Graha Futsal</title>
	...
	<header class="header_area sticky-header">
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
              ...
              <li class="nav-item"><a class="nav-link" href="{{ route('pemainBookingDetail') }}">Booking</a></li>
			...
			<div class="row">
				<!-- <div class="col-lg-6">
					<div class="login_box_img">
						<img class="img-fluid" src="{{ url('assets/front/img/login.jpg') }}" alt="">
						<div class="hover">
							<h4>Graha Futsal</h4>
							<p>Booking lapangan futsal online, <br> Belum punya akun?</p>
							<a class="primary-btn" href="registration.html">Daftar</a>
						</div>
					</div>
				</div> -->
				<div class="col-md-12">
					<div class="login_form_inner">
						<h3>registrasi</h3>
						<form action="{{ route('daftar') }}" method="POST" class="row login_form" id="contactForm" novalidate="novalidate">
                        @csrf
                            ...
                            <div class="col-md-12 form-group">
								<input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" placeholder="Tgl Lahir" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Tgl Lahir'">
							</div>
                            <div class="col-md-12 form-group">
                            ...
                            <div class="col-md-12 form-group">
								<input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="No HP" onfocus="this.placeholder = ''" onblur="this.placeholder = 'No HP'">
							</div>
                            <div class="col-md-12 form-group">
								<input type="email" class="form-control" id="email" name="email" placeholder="Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email'">
							</div>
                            <div class="col-md-12 form-group">
								<input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat" onfocus="this.placeholder = ''" onblur="this.placeholder = 'No HP'">
							</div>
							<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<div class="creat_account">
									...
									<label for="f-option2">Saya menyetujui aturan dan ketentuan Graha Futsal</label>
								</div>
							</div>
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" class="primary-btn">Registrasi</button>
                <div class="creat_account">
                  <label for="f-option2">Sudah punya akun?</label> <a href="{{ route('login') }}" style="display:inline;">Login</a>
                </div>
							</div>
						</form>
					</div>
