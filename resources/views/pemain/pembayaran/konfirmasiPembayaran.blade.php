...
<!-- Start Banner Area -->
	...
	<section class="order_details section_gap">
		<div class="container">
			<h3 class="title_confirmation">Terimakasih. Booking anda diterima, silahkan lakukan pembayaran.</h3>
			...
			<div class="row offset-2">
				<div class="col-5">
					<p>Jika sudah melakukan pembayarn silahkan klik</p>
				</div>
				<div class="col-2">
					<button type="button"  data-toggle="modal" data-target="#uploadbuktipembayaran" class="btn btn-sm btn-warning">Upload Bukti Pembayaran</button>
				</div>
			</div>
		</div>
	</section>
