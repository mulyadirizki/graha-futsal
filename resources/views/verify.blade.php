...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Verify | Graha Futsal</title>
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="{{ route('home') }}">Graha Futsal</a>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="login_form_inner">
						<h3>Waiting for account verification by the admin</h3>
						@if(session('success'))
						...
						<div class="row login_form" id="contactForm" novalidate="novalidate">
              				@csrf
                            <?php if($user->statusenabled == 0) { ?>
                                <div class="col-md-12 form-group">
                                    <h3 class="badge badge-info" style="text-transform: capitalize; color: white">Unverified</h3>
                                    <div class="creat_account" style="text-align: center;">
                                        <label for="f-option2">Belum punya akun?</label> <a href="{{ route('register') }}" style="display:inline; color: blue;">Daftar</a>
                                    </div>
                                </div>
                            <?php } else { ?>
                                <div class="col-md-12 form-group">
                                    <h3 class="badge badge-success" style="text-transform: capitalize; color: white">Verified</h3>
                                </div>
                                <div class="col-md-12 form-group">
                                    <a href="{{ route('login') }}">
                                    ...
                                    <div class="creat_account">
                                        <label for="f-option2">Belum punya akun?</label> <a href="{{ route('register') }}" style="display:inline;">Daftar</a>
                                    </div>
                                </div>
                            <?php } ?>
						</div>
